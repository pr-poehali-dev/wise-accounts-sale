  ...
  return (
    <Card className="w-full max-w-lg mx-auto shadow-lg">
      <CardHeader className="bg-wiseLight rounded-t-lg">
        <CardTitle className="text-2xl text-center text-wiseDarkGreen">Заказать аккаунты Wise</CardTitle>
      </CardHeader>
      ...
      <CardContent className="pt-6 space-y-6">
        <div className="bg-wiseLight p-6 rounded-lg">
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="text-xl font-bold text-wiseDarkGreen">{pricePerAccount.toLocaleString()} ₽</span>
          </div>
          ...
          <div className="flex items-center justify-between bg-white p-3 rounded-md">
            <span className="font-medium text-wiseDarkGreen">Количество аккаунтов:</span>
